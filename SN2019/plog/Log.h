...
#define PLOG_(instance, severity)        IF_PLOG_(instance, severity) (*plog::get<instance>()) += plog::Record(plog::get<instance>()->m_time,severity, PLOG_GET_FUNC(), __LINE__, PLOG_GET_FILE(), PLOG_GET_THIS()).ref()
...
#define LOG_(instance, severity)        IF_PLOG_(instance, severity) (*plog::get<instance>()) += plog::Record(plog::get<instance>()->m_time,severity, PLOG_GET_FUNC(), __LINE__, PLOG_GET_FILE(), PLOG_GET_THIS()).ref()
...
#define PHEX(value,width) std::hex << std::uppercase << std::setfill(PLOG_NSTR('0')) << std::setw(width) << value
#define PHEX8(value) PHEX(value,8)
#define PHEX4(value) PHEX(value,4)
#define PHEX2(value) PHEX(value,2)
